...
public class CustomerDto {
    ...
    @Size(min = 5, max = 30, message = "Number of characters in name should be between 5 and 30")
    private String name;

    @Schema(description = "Email address of the customer", example = "tutor@eazybytes.com")
    @NotEmpty(message = "E-mail ID cannot be empty")
    @Email(message = "E-mail ID should be valid value")
